...
1.	[Frequently Asked Questions](#frequently-asked-questions)
	...
	3.	[Installation](#install)
		1.  [It's not easy to install all dependencies of GPTune correctly, is there a simpler way?](#spack)
		2.	[I cannot install GPTune correctly, is there an alternative?](#docker)
...
### What is jq?
jq is a Linux command line utility that is easily used to extract data from JSON documents. The RCI mode relies on jq to update the GPTune database. 
class Options(Mapping):
    ...
    def __init__(self, **kwargs):
        ...
        search_algo = ['pso', 'cmaes']
        search_udi = ['thread_island', 'mp_island', 'ipyparallel_island']
        #XXX 'mp_island' : advise the user not to use this kind of udi as it lunches several processes and deadlock on some weird semaphores

...
mpirun --oversubscribe --mca pmix_server_max_wait 3600 --mca pmix_base_exchange_timeout 3600 --mca orte_abort_timeout 3600 --mca plm_rsh_no_tree_spawn true -n 1 python ./scalapack_MLA_history_db.py -nodes ${nodes} -cores ${cores} -nprocmin_pernode ${nprocmin_pernode} -ntask ${ntask} -nrun ${nrun} -machine cori | tee loadmodel_eval3/a.out_scalapck_MLA_nodes${nodes}_core${cores}_ntask${ntask}_nrun${nrun}_oversubscribe

cp scalapack-pdqrdriver.json loadmodel_eval3/scalapack-pdqrdriver.first.json
cp modeling_stat_scalapack.csv loadmodel_eval3/modeling_stat_scalapack.csv

rm scalapack-pdqrdriver.json
rm modeling_stat_scalapack.csv

cp loadmodel_eval3/scalapack-pdqrdriver.first.json scalapack-pdqrdriver.json

nrun=20
mpirun --oversubscribe --mca pmix_server_max_wait 3600 --mca pmix_base_exchange_timeout 3600 --mca orte_abort_timeout 3600 --mca plm_rsh_no_tree_spawn true -n 1 python ./scalapack_MLA_history_db.py -nodes ${nodes} -cores ${cores} -nprocmin_pernode ${nprocmin_pernode} -ntask ${ntask} -nrun ${nrun} -machine cori | tee loadmodel_eval3/a.out_scalapck_MLA_nodes${nodes}_core${cores}_ntask${ntask}_nrun${nrun}_oversubscribe_history_db

cp scalapack-pdqrdriver.json loadmodel_eval3/scalapack-pdqrdriver.history_db.json
cp modeling_stat_scalapack.csv loadmodel_eval3/modeling_stat_scalapack.history_db.csv
...
nrun=20
mpirun --oversubscribe --mca pmix_server_max_wait 3600 --mca pmix_base_exchange_timeout 3600 --mca orte_abort_timeout 3600 --mca plm_rsh_no_tree_spawn true -n 1 python ./scalapack_MLA_loadmodel.py -nodes ${nodes} -cores ${cores} -nprocmin_pernode ${nprocmin_pernode} -ntask ${ntask} -nrun ${nrun} -machine cori | tee loadmodel_eval3/a.out_scalapck_MLA_nodes${nodes}_core${cores}_ntask${ntask}_nrun${nrun}_oversubscribe_loadmodel_max_eval

cp scalapack-pdqrdriver.json loadmodel_eval3/scalapack-pdqrdriver.loadmodel.json
cp modeling_stat_scalapack.csv loadmodel_eval3/modeling_stat_scalapack.loadmodel.csv

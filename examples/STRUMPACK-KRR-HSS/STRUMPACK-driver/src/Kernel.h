...
extern "C" {
  ...
  (STRUMPACKKernel K, double* labels, int oversampling, int vann, int epow, int argc, char* argv[]);
  void STRUMPACK_kernel_fit_HSS_float
  (STRUMPACKKernel K, float* labels, int oversampling, int vann, int epow, int argc, char* argv[]);

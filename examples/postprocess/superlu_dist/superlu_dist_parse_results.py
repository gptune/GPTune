...
def main(args):
    summary = []
    my_source = f"./{args.exp}_superlu_dist_nodes{args.nodes}_ntask{args.ntask}.txt"
    save_path = f"./{args.exp}_superlu_dist_nodes{args.nodes}_ntask{args.ntask}.pkl"
    print(my_source)
        ...
        while line:
            ...
            if info[0] == 'Task':
                ...
                while line.strip() != "":
                    ...
                    line = f.readline()
                summary.append((task_id, runs, results))
            line = f.readline()

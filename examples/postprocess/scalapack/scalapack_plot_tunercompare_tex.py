...
def plot(data1, data2, args):
    ...
    ax.set_title(f'[m, n] in [{args.mmax}, {args.nmax}], '+r'$\epsilon_{tot}$'+f' = {nrun}',fontdict=font)   
    ax.set_xticks(x)
...
def plot_histogram(data1, data2, args):
    ...
    ax1.set_title(f'[m, n] in [{args.mmax}, {args.nmax}], '+r'$\epsilon_{tot}$'+f' = {nrun}',fontdict=font)

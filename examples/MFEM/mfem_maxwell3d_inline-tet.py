...
mpirun -n 1 python mfem_maxwell3d.py -nodes 1 -cores 32 -nprocmin_pernode 1 -ntask 20 -nrun 800 -machine cori
...
def main():
	...
	sp_compression_min_sep_size     = Integer     (12, 20, transform="normalize", name="sp_compression_min_sep_size")
	sp_compression_min_front_size     = Integer     (500, 2000, transform="normalize", name="sp_compression_min_front_size")
	...
	data.I = giventask
	Pdefault = [int(math.log2(nprocmin_pernode)),15,1000,8,6,2]

...
def main():
    ...
    problem = TuningProblem(input_space, parameter_space,output_space, objectives, constraints, models=None, input_var=input_var)  # no performance model
    ...
    options['model_class'] = 'Model_GPy_LCM' #'Model_LCM' 'Model_GPy_LCM' 'Model_GPFlow_LCM'

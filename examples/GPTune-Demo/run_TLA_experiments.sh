...
do
    ...
    do
        rm -rf gptune.db
        merge_db.py TLA_experiments/SLA-GPTune-0.8-50/GPTune-Demo.json TLA_experiments/SLA-GPTune-1.2-50/GPTune-Demo.json
        mkdir -p gptune.db
        mv db.out gptune.db/GPTune-Demo.json
        mpirun -n 1 python ./demo_TLA.py -ntask 3 -nrun ${nrun} -tvalue ${tvalue} -tvalue2 ${tvalue2} -tvalue3 ${tvalue3} -tvalue4 ${tvalue4} -tvalue5 ${tvalue5} | tee a.out.log
...
do
    ...
    do
        rm -rf gptune.db
        merge_db.py TLA_experiments/SLA-GPTune-0.6-50/GPTune-Demo.json TLA_experiments/SLA-GPTune-0.8-50/GPTune-Demo.json TLA_experiments/SLA-GPTune-1.2-50/GPTune-Demo.json TLA_experiments/SLA-GPTune-1.4-50/GPTune-Demo.json 
        mkdir -p gptune.db
        mv db.out gptune.db/GPTune-Demo.json

...
do  
    ...
    bash nimrod_SLA_baseline.sh -a $nstep -b $expid -c $seed -d $nrun -e $npilot | tee log.nimrod_SLA_baseline_nstep${nstep}_expid${expid}_seed${seed}_nrun${nrun}_npilot${npilot}  #a: nstepmax b: nstepmin c: Nloop d: optimization e: expid f: seed

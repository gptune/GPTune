...
def parse_args():
    ...
    parser.add_argument('-attribute', type=str, default='1.0', help='Task')
...
def objectives(point):
    ...
    with open("gptune-search-lcm.db/winequality."+str(nrun)+"."+attribute+".log", "a") as f_out:
...
def main():
    ...
    with open("gptune-search-lcm.db/winequality."+str(nrun)+"."+attribute+".log", "w") as f_out:
        f_out.write("NKnots,Lambda,RegressionTime,InTestTime,InMSE,InR2,InAR2,OutTestTime,OutMSE,OutR2,OutAR2\n")

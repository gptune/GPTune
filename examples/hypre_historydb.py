...
python hypre_historydb.py -nxmax 200 -nymax 200 -nzmax 200 -nodes 1 -cores 32 -nprocmin_pernode 1 -ntask 20 -nrun 800 -machine cori -jobid 0
...
def main():
    ...
    giventask = [[100, 100, 100], [120, 120, 120], [140, 140, 140], [160, 160, 160], [180, 180, 180]]
    print (giventask)

    gt = GPTune(problem, computer=computer, data=data, options=options,
            history_db=history_db, driverabspath=os.path.abspath(__file__))
    ...
    with open("modeling_stat_hypre.csv", "w") as f_out:

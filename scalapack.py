...
python example_scalapack.py -mmax 5000 -nmax 5000 -nodes 1 -cores 32 -ntask 20 -nrun 800 -machine cori -jobid 0
...
#    RUNDIR = initialize(0, 0, nodes, cores, nruns, truns, "mogpo", machine, JOBID=JOBID)
    ...
    m     = Integer (1 , mmax, name="m")
    n     = Integer (1 , nmax, name="n")
    mb    = Integer (1 , mmax, name="mb")
    nb    = Integer (1 , nmax, name="nb")
    nproc = Integer (nodes, nodes*cores, name="nproc")
    p     = Integer (1 , nodes*cores, name="p")
...
#    cst4 = "int(nproc / p) == (nproc / p)" # intrinsically implies "p <= nproc"
    ...
    gt = GPTune(IS, PS, OS, myobjfun, constraints, models)

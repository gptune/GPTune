...
mpirun -N 15 --map-by ppr:64:node --mca pmix_server_max_wait 3600 --mca pmix_base_exchange_timeout 3600 --mca orte_abort_timeout 3600 --mca plm_rsh_no_tree_spawn true -n 1  python ./m3dc1_single_Run05_A_XY_nblock.py -nodes 224 -cores 2 -ntask 1 -nrun 20 -machine cori -jobid 0

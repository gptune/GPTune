...
if [ $ModuleEnv = 'frontier-EPYC-craympich-gnu' ]; then
	export CRAYPE_LINK_TYPE=dynamic
	module load PrgEnv-gnu
	GPTUNEROOT=$PWD
	BLAS_LIB="/opt/cray/pe/libsci/22.12.1.1/GNU/9.1/x86_64/lib/libsci_gnu_82_mpi_mp.so"
	LAPACK_LIB="/opt/cray/pe/libsci/22.12.1.1/GNU/9.1/x86_64/lib/libsci_gnu_82_mpi_mp.so"
	SCALAPACK_LIB="/opt/cray/pe/libsci/22.12.1.1/GNU/9.1/x86_64/lib/libsci_gnu_82_mpi_mp.so"
	MPICC=cc
	MPICXX=CC
	MPIF90=ftn
	OPENMPFLAG=fopenmp
...
env CC=$MPICC pip install --user -r requirements_frontier.txt
...
cmake .. \
	...
	-DPython3_EXECUTABLE=/opt/cray/pe/python/$PY_VERSION_FULL/bin/python \

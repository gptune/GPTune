...
if [ $ModuleEnv = 'ex3-xeongold16q-openmpi-gnu' ]; then
	...
	if [[ $MPIFromSource = 1 ]]; then
		...
		export LD_LIBRARY_PATH=/cm/shared/apps/openmpi/gcc/64/4.0.1/lib:$LD_LIBRARY_PATH
		export LIBRARY_PATH=/cm/shared/apps/openmpi/gcc/64/4.0.1/lib:$LIBRARY_PATH 
		export PATH=$PATH:/cm/shared/apps/openmpi/gcc/64/4.0.1/bin 
		########################################
